...
class ClassAnalyzer extends ClassLikeAnalyzer
{
    ...
    public function analyze(
        ...
        if ($this->leftover_stmts) {
            (new StatementsAnalyzer($this, new \Psalm\Type\Provider()))->analyze($this->leftover_stmts, $class_context);
        }
    ...
    private function checkPropertyInitialization(
        ...
        if ($constructor_analyzer) {
            ...
            $constructor_analyzer->analyze($method_context, new \Psalm\Type\Provider(), $global_context, true);
    ...
    private function analyzeClassMethod(
        ...
        $type_provider = new \Psalm\Type\Provider();
